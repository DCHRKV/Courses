...
//            Text("Value \(x)")
    ...
    func path(in rect: CGRect, x: Double, x2: Double) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.38966*width*x2, y: 0.96923*height), control1: CGPoint(x: 1.09655*width*x2, y: 0.48846*height), control2: CGPoint(x: 0.59533*width, y: 0.96923*height))
        ...
        path.addCurve(to: CGPoint(x: 0.63103*width*x, y: 0.00769*height*x), control1: CGPoint(x: 0.01724*width*x, y: 0.43846*height*x2), control2: CGPoint(x: -0.01034*width, y: -0.06154*height*x))
        path.addCurve(to: CGPoint(x: 0.95862*width, y: 0.41923*height), control1: CGPoint(x: 1.27241*width*x2, y: 0.07692*height*x2), control2: CGPoint(x: 0.82069*width, y: 0.35*height))
        path.closeSubpath()
        return path
    }
}
